...
@section('content')
    <h1 class="col-md-9 col-md-offset-1"> Создание клиента</h1>
    {!! Form::open(['route' => 'clients-panel.store']) !!}
    ...
    <div class="form-group">
        <div class="col-md-9 col-md-offset-3">
            {{Form::submit('Добавить клиента в базу',['class'=>'btn btn-primary','data-toggle'=>'modal','data-target'=>'#myModal'])}}
